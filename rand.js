/* UMD.define */ (function (root, factory) {
	...
	var
        ...
        cities = "Bowie,Ventress,Boomer,Lafferty,Welch,Hillsboro,Woodruff,Siglerville,Lowgap,Russellville,Carlos,Catherine,Fairlee,Canby,Chalfant,Belva,Golconda,Choctaw,Riceville,Brookfield,Odessa,Northchase,Waterloo,Berwind,Grantville,Tryon,Harviell,Collins,Blanford,Bison,Camino,Alleghenyville,Ypsilanti,Edgar,Chilton,Diaperville,Falmouth,Enoree,Crumpler,Edinburg,Trona,Hiko,Cucumber,Whitehaven,Worton,Elwood,Garnet,Knowlton,Murillo,Yorklyn,Lopezo,Gardiner,Bainbridge,Enetai,Northridge,Goodville,Lynn,Faxon,Selma,Yonah,Maxville,Cumberland,Urie,Matheny,Eastmont,Hayden,Lindisfarne,Thynedale,Fulford,Norfolk,Harrodsburg,Brady,Crucible,Fresno,Wikieup,Kipp,Otranto,Hoagland,Broadlands,Westerville,Newkirk,Allentown,Volta,Celeryville,Canterwood,Sterling,Heil,Axis,Emison,Genoa,Warren,Sylvanite,Brambleton,Staples,Cannondale,Marne,Itmann,Morriston,Morgandale,Baden".split(','),
        ...
        companies = "Futurize,Ebidco,Brainclip,Hometown,Kongene,Plexia,Isosure,Fishland,Extremo,Comveyor,Isoplex,Aquasseur,Medicroix,Neurocell,Comvey,Zolar,Ultrimax,Kiggle,Besto,Inquala,Typhonica,Cuizine,Hyplex,Endipin,Gallaxia,Valreda,Irack,Quilk,Ziggles,Paragonia,Fuelton,Isotrack,Qot,Centrexin,Gaptec,Zillatide,Comdom,Vendblend,Ecratic,Capscreen,Parleynet,Thredz,Vidto,Plasto,Billmed,Norali,Gleamink,Portico,Lyria,Dyno,Intradisk,Tellifly,Xleen,Dymi,Terragen,Geoforma,Zillidium,Mitroc,Zensor,Lexicondo,Techade,Biflex,Calcu,Providco,Volax,Krag,Fangold,Rodeology,Bisba,Quilch,Makingway,Pearlessa,Acrodance,Zilla,Geekular,Decratex,Accufarm,Songbird,Mondicil,Exozent,Kegular,Arctiq,Austech,Dentrex,Cujo,Grupoli,Neteria,Deminimum,Telequiet,Ontagene,Enervate,Buzzmaker,Utarian,Ecrater,Gogol,Comtest,Terascape,Sloganaut,Remotion,Elpro".split(',')
	...
	rand = {
		...
		format: function (n, type) {
			...
			switch (type) {
				case 'phone':
					n = '' + n;
					return '(' + n.substring(0,3) +') ' + n.substring(3,6) + d + n.substring(6);
				case 'ssn':
					n = '' + n;
